...
public class LandmarkJDBCQueryExecution extends JDBCBaseExecution implements ResultSetExecution {

    protected ResultSet results;
    protected Command command;
    protected Class<?>[] columnDataTypes;

    public LandmarkJDBCQueryExecution(Command command, Connection connection, ExecutionContext context, JDBCExecutionFactory env) {
